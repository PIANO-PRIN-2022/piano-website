...
{% include post_fig.html src=page.image alt="PIANO-related paper has won an impact recognition award" %}
...
- [Read the open access paper at the ACM library](https://dl.acm.org/doi/abs/10.1145/3711085)
- [ACM CSCW 2025](https://cscw.acm.org/2025/)